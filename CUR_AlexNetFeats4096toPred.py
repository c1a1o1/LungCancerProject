...
np.save('temp/validationAutoencoded.npy',validationEncoded)
np.save('temp/trainTestAutoencoded.npy',trainTestEncoded)
"""
validationEncoded = np.load('temp/validationAutoencoded.npy')
trainTestEncoded = np.load('temp/trainTestAutoencoded.npy')
